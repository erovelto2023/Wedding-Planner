...
export default function BachelorWouldYouRatherPage() {
  const [items, setItems] = useState([
    { optionA: 'Go skydiving with the group', optionB: 'Go on a calm fishing trip' },
    { optionA: 'Drink only cheap beer all weekend', optionB: 'Drink only top-shelf whiskey' },
    { optionA: 'Stay in a luxury hotel downtown', optionB: 'Camp in the wilderness' },
    { optionA: 'Have a massive party with 50+ people', optionB: 'Have a small gathering with just the closest friends' },
    { optionA: 'Eat at a fancy steakhouse', optionB: 'Eat at a greasy diner/food truck' },
    { optionA: 'Go to a strip club', optionB: 'Go to a sports bar or casino' },
    { optionA: 'The groom gets a tattoo', optionB: 'The groom gets a piercing' },
    { optionA: 'Wake up early for golf', optionB: 'Sleep in after a late night' }
  ]);
  ...
  return (
    <div className="printable-content" style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div className="heading-container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: '2.5rem' }}>Bachelor: Would You Rather?</h1>
      ...
      <div className="card canvas-to-print" style={{ padding: '2rem' }}>
        <p style={{ color: 'var(--text-secondary)', textAlign: 'center', marginBottom: '2rem' }}>Guess what the groom would choose! Circle Option A or Option B.</p>
